			...
			<div class="container-fluid">
				...
				<div class="_1adminOverveiw_table_recent _box_shadow _border_radious _mar_b30 _p20">
					<p class="_title0">Assign Role :
                        <Select v-model="data.id" placeholder="Select Type" style="width:300px" @on-change="changeRole" v-if="isWritePermitted">
					...
					<div class="_overflow _table_div">
                        ...
                        <div class="center_button">
                                <Button type="primary" :loading="isSending" :disabled="isSending" @click="assignRoles" v-if="isDeletePermitted">Save Change</Button>
                            </div>
					</div>
				</div>
			</div>
...
export default {
	data(){
		return{
			...
			resources: [
                ...
                {resourceName : 'Create Article', read : false, write : false, update : false, delete : false, name : 'createArticle'},
	...
	methods:{
        async assignRoles(){
            ...
            if (res.status == 200) {
                this.s('Role has Change Successfully!')

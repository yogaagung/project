        ...
        <div class="content">
			<div class="container-fluid">
				...
				<div class="_1adminOverveiw_table_recent _box_shadow _border_radious _mar_b30 _p20">
					<p class="_title0">Create Article</p>
					<div class="_input_field">
						<Input  type="textarea" v-model="data.title" placeholder="Title " />
					</div>
                    ...
                    <div class="_input_field" style="text-align:center">
                        <Button type="primary" @click="save" :loading="isCreating" :disabled="isCreating">{{isCreating ? 'Please wait...' : 'Create Article'}}</Button>
                    </div>
				</div>
			</div>
		</div>
...
export default {
	...
	methods:{
		async onSave(response){
			...
			if(res.status === 200){
				this.s('Article has been Created Successfully')

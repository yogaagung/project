			...
			<div class="container-fluid">
						...
						<table class="_table">
							...
							<tr v-for="(category, i) in categoryLists" :key="i" v-if="categoryLists.length">
								...
								<td>
									...
									<Button type="error" size="small" @click="showDeleteingModal(category, i)" :loading="category.isDeleting" v-if="isDeletePermitted">Delete</Button>
								</td>
							</tr>
								<!-- ITEMS -->
						</table>
				...
				<Modal
					...
					<div class="demo-upload-list" v-if="data.iconImage">
						...
						<div class="demo-upload-list-cover">
							<Button type="error"  ghost size="small" shape="circle" icon="ios-trash-outline" @click="deleteImage">Delete All Image</Button>
				...
				<Modal
					...
					<div class="demo-upload-list" v-if="editData.iconImage">
						...
						<div class="demo-upload-list-cover">
							<Button type="error"  ghost size="small" shape="circle" icon="ios-trash-outline" @click="deleteImage(false)">Delete Image</Button>
							<!-- <Icon type="ios-trash-outline" @click="deleteImage"></Icon> -->
						</div>
					</div>
					<div slot="footer">
...
export default {
	...
	methods:{
		async addCategory(){
			...
			if (this.data.iconImage.trim()=='') return this.e('Image is Required')
		...
		showDeleteingModal(category, i){
			...
			const deleteModalObj = {
                ...
                successMsg : 'Category Has Been Delete Successfully!'
			}
